...
<body>
        ...
        <nav class="navbar navbar-expand p-0">
            <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="index.html"> Larashop </a>
                <button class="btn btn-link d-bloc d-md-none" data-toggle="collapse" data-target="#sidebar-nav" role="button">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" id="navbar-dropdown">
                            ...
                            <li>
                                <form action="{{route("logout")}}" method="POST">
                                    @csrf
                                    <buttton class="dropdown-item" style="cursor:pointer">Sign Out</button>
                                </form>
                            </li>
                        </div>
                    </div>
