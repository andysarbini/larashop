...
<div class="row">
    ...
    @endif
        ...
        class="p-3 shadow-sm bg-white">
            ...
            <input type="text" placeholder="Author" value="{{$book->author}}" id="author" name="author" class="form-control"><br>

            <label for="publisher">Publisher</label>
            <input type="text" class="form-control" placeholder="Publisher" name="publisher" id="publisher" value="{{$book->publisher}}"><br>
